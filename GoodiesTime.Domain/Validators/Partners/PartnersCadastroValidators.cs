...
{
    public class PartnersCadastroValidators : AbstractValidator<tb_partnersDto>
    {
        private readonly Itb_partnersRepository itb_partnersRepository;

        public PartnersCadastroValidators(Itb_partnersRepository itb_partnersRepository)
        {
